				...
				<div class="panelContent">
                    <div class="terms">
                        ...
                        <div class="sectionContent">
                            ...
                            <p>You may link to or include outside resources or materials in your SCORE projects or in any public parts of the WISE site, but it is your responsibility to obtain any necessary permission from the original owners and include any required attribution for your use of such content. WISE will not be held responsible for the unauthorized use by a SCORE account holder of any third-party content in SCORE projects or on any other sections of the WISE site.</p>

                            <h4 id="auto-generated-content">Auto-Generated Data</h4>
                            <p>When students and teachers use WISE, we save event data such as mouse clicks, time spent viewing pages, and other site interactions. This data is used for research purposes and for automated analyses and tools within SCORE project runs. (See ‘How We Use the Data' for more information.)</p>
                        ...
                        <div class="sectionContent">
                            ...
                            <p>We may occasionally update or modify our Terms of Use and Privacy Policy. We will always display the date this document was last updated. If we make significant changes to these terms, we will display a prominent notice on the SCORE home page and may notify users via registered email.  We encourage you to review this document periodically. By continuing to use WISE after any changes to this document, you acknowledge that you agree to the current version of these terms.</p>
